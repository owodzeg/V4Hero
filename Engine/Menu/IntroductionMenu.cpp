...
void IntroductionMenu::Initialize()
{
    ...
    msgcloud.Create(45, sf::Vector2f(640, 480), sf::Color::White, true, CoreManager::getInstance().getConfig()->Get<int>("textureQuality"), CoreManager::getInstance().getConfig()->fontPath);
