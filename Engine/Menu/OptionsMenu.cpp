...
OptionsMenu::OptionsMenu()
{
    ...
    t_restart.setCharacterSize(26);
    t_restart.setColor(sf::Color::Black);
    t_restart.setStringKey("options_restart_notice");
    ...
    /*
    options_header.setFont(font);
    options_header.setCharacterSize(45);
    options_header.setColor(sf::Color::White);
    options_header.setStringKey("options_options");

    PText opt;
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_graphics");
    options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_audio");
    options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_input");
    options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_language");
    options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_backtomain");
    options.push_back(opt);

    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_graphics1");
    g_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_graphics2");
    g_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_graphics4");
    g_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_graphics5");
    g_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_graphics6");
    g_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_back");
    g_options.push_back(opt);
    ...
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_unlimited");
    ...
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_quality_low");
    qualities.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_quality_medium");
    qualities.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_quality_high");
    qualities.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_quality_ultra");
    qualities.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    ...
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_audio1");
    a_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_audio2");
    a_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_audio3");
    a_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_audio4");
    a_options.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    ...
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_volume1");
    ms_volume.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_volume2");
    ms_volume.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_volume3");
    ms_volume.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    ...
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_enable");
    switches.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
    opt.setStringKey("options_disable");
    switches.push_back(opt);
    opt.setFont(font);
    opt.setCharacterSize(25);
    opt.setColor(sf::Color::White);
