...
void TestChamber::Initialize()
{
    ...
    ptext.append("{speed 0}{color 255 0 0}{size 30}Hello, {size 50}VAVAVAVAVAVA! lllllllllllll{n}{bold}V4Hero Client v1.2 is real!{n}{size 10}This {size 15}is {size 40}{color 0 255 128}a test {color 0 0 0}{size 20}of the {italic}PataText{italic} system.{bold}{n}{size 60}{color 255 0 0}R{color 255 128 0}A{color 255 255 0}I{color 128 255 0}N{color 0 255 0}B{color 0 255 128}O{color 0 255 255}W{color 0 0 0}{size 30}{n}{n}Let's test kerning!{n}VAVAVAVAVAVAVA{n}{font fallback}VAVAVAVAVAVAVA{n}{font kerningtest}VAVAVAVAVAVAVA{n}{font kaku-uni}The quick brown fox jumps over a lazy dog.{n}{font kaku-cn}The quick brown fox jumps over a lazy dog.{n}{font fallback}The quick brown fox jumps over a lazy dog.{font kaku-uni}{n}{size 30}{speed 10}{wait 3000}Yo... I heard that these... {wait 500}{speed 5}{shake 2}{color 255 0 0}{bold}KIRAJINS{speed 10}{bold}{color 0 0 0}{shake 0} are some real trouble...{n}{wait 1000}{hwave 4 10}I'm dizzy.{wait 1000}{hwave 0 0}{n}{n}{wait 1000}{vwave 6 10}heyyyyyy sweetie <3{vwave 0 0}{n}{n}{wait 1000}{shake 5}{hwave 6 10}{vwave 7 10}oh{color 100 0 0}hh hh{color 0 0 0}h {font kaku-cn}my{size 50}y{color 0 200 0}yy{font kaku-uni} gg{color 0 0 0}o{size 20}oo{font fallback}oo{color 255 0 255}o{size 20}ddd{color 0 0 0}{size 30}dd{font kaku-uni}ddd {color 255 0 0}{shake 10}{speed 7}AAAAA{shake 15}{speed 5}{size 50}AAAAA{shake 20}{size 70}{speed 3}AAAAAA");
