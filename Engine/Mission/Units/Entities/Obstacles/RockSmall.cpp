...
void RockSmall::LoadConfig()
{
    /// all (normal) kacheeks have the same animations, so we load them from a hardcoded file
    AnimatedObject::LoadConfig("resources/units/entity/rock_Small.p4a");
...
void RockSmall::parseAdditionalData(nlohmann::json additional_data)
{
