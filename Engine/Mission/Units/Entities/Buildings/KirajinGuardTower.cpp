...
void KirajinGuardTower::LoadConfig()
{
    /// all (normal) kacheeks have the same animations, so we load them from a hardcoded file
    AnimatedObject::LoadConfig("resources/units/entity/kirajin_guardtower.p4a");
...
void KirajinGuardTower::parseAdditionalData(nlohmann::json additional_data)
{
    cout << "KirajinGuardTower::parseAdditionalData: " << additional_data << endl;
